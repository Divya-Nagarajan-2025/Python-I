calc.py is my very first coding once I decided to learn python. Its all about basic calculator operations where the user get access to perfoSrm addition, subtraction, multiiplication and division.
